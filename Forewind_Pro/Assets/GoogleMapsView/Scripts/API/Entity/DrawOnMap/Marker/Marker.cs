...
#pragma warning restore 0162
		...
		public void SetIcon(ImageDescriptor imageDescriptor)
		{
			...
			_googleMapsViewMarkerSetImage(_markerPtr, imageDescriptor.AssetName.ToFullStreamingAssetsPath());
#endif
...
#pragma warning restore 0162
...
#if UNITY_IOS && !DISABLE_IOS_GOOGLE_MAPS
			_googleMapsViewMarkerIsInfoWindowShown(_markerPtr, _mapPtr);
#endif
		...
		[DllImport("__Internal")]
		static extern void _googleMapsViewMarkerSetImage(IntPtr markerPtr, string imagePath);
