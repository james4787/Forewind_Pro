namespace DeadMosquito.GoogleMapsView
{
	...
	/// <inheritdoc />
	/// <summary>
	/// Bitmap overlay centered at the start or end vertex of a <see cref="T:DeadMosquito.GoogleMapsView.Polyline" />, orientated according to the direction of the line's first or last edge and scaled with respect to the line's stroke width.
