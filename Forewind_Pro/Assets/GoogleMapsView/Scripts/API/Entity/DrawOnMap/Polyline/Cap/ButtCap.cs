namespace DeadMosquito.GoogleMapsView
{
	...
	/// <inheritdoc />
	/// <summary>
	/// Cap that is squared off exactly at the start or end vertex of a <see cref="T:DeadMosquito.GoogleMapsView.Polyline" /> with solid stroke pattern, equivalent to having no additional cap beyond the start or end vertex. 
