...
#else
using UnityEditor.iOS.Xcode.GoogleMapsView.PBX;
#endif

#if UNITY_XCODE_API_BUILD
namespace UnityEditor.iOS.Xcode
#else
namespace UnityEditor.iOS.Xcode.GoogleMapsView
#endif
{
    using PBX;
    using PBXBuildFileSection           = PBX.KnownSectionBase<PBX.PBXBuildFileData>;
    using PBXFileReferenceSection       = PBX.KnownSectionBase<PBX.PBXFileReferenceData>;
    using PBXGroupSection               = PBX.KnownSectionBase<PBX.PBXGroupData>;
    using PBXContainerItemProxySection  = PBX.KnownSectionBase<PBX.PBXContainerItemProxyData>;
    using PBXReferenceProxySection      = PBX.KnownSectionBase<PBX.PBXReferenceProxyData>;
    using PBXSourcesBuildPhaseSection   = PBX.KnownSectionBase<PBX.PBXSourcesBuildPhaseData>;
    using PBXFrameworksBuildPhaseSection= PBX.KnownSectionBase<PBX.PBXFrameworksBuildPhaseData>;
    using PBXResourcesBuildPhaseSection = PBX.KnownSectionBase<PBX.PBXResourcesBuildPhaseData>;
    using PBXCopyFilesBuildPhaseSection = PBX.KnownSectionBase<PBX.PBXCopyFilesBuildPhaseData>;
    using PBXShellScriptBuildPhaseSection = PBX.KnownSectionBase<PBX.PBXShellScriptBuildPhaseData>;
    using PBXVariantGroupSection        = PBX.KnownSectionBase<PBX.PBXVariantGroupData>;
    using PBXNativeTargetSection        = PBX.KnownSectionBase<PBX.PBXNativeTargetData>;
    using PBXTargetDependencySection    = PBX.KnownSectionBase<PBX.PBXTargetDependencyData>;
    using XCBuildConfigurationSection   = PBX.KnownSectionBase<PBX.XCBuildConfigurationData>;
    using XCConfigurationListSection    = PBX.KnownSectionBase<PBX.XCConfigurationListData>;
    using UnknownSection                = PBX.KnownSectionBase<PBX.PBXObjectData>;
