...
namespace DeadMosquito.GoogleMapsView.Demo
{
	...
	public static class DemoUtils
	{
		...
		static MarkerOptions NewMarkerOptions(LatLng london, ImageDescriptor imageDescriptor)
		{
...
//                .Position(new LatLng(BerlinLatitude, BerlinLongitude), 303000, 150000)
		...
		public static List<ClusterItem> DeserializeCluserMarkers(string jsonData)
		{
			var heatmapData = new List<ClusterItem>();
			...
			foreach (var item in deserialized)
			{
				...
				heatmapData.Add(new ClusterItem(latLng, title, snippet));
			}
